...
//            System.out.println(this.getNode(i).get().hashCode());
     ...
     */
    public Optional<T> getNode(int index) {
        if (index < 0) {
    ...
    public Optional<T> getMiddle() {
        ...
        return Optional.ofNullable(slow.getData());
    }
    ...
    public Optional<T> removeLast() {
        ...
        size--;
        return Optional.ofNullable(tail).isPresent() ? Optional.ofNullable(tail.getData()) : Optional.empty();
    }
    ...
    public Optional<T> removeStart() {
        ...
        size--;
        return Optional.ofNullable(head).isPresent() ? Optional.ofNullable(head.getData()) : Optional.empty();
    }
    ...
    public Optional<T> remove(int index) {
        ...
        return Optional.ofNullable(deletedNode).isPresent() ? Optional.ofNullable(deletedNode.getData()) : Optional.empty();
    }
