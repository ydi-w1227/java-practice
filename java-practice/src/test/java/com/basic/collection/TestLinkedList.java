...
// removeLast necessary to be Optional<Node<T>> and here use String
...
public class TestLinkedList {
    ...
    class TestLinkedListDetail {
        ...
        void shouldAddNodeAtStartOfLinkedList() {
            ...
            Optional<String> rlt = linkedList.getNode(0);
            assertEquals("Third Node", rlt.isPresent() ? rlt.get() : Optional.empty());
            Iterator<String> iterator = linkedList.iterator();
            if (iterator.hasNext()) {
                Optional<String> rlt2 = linkedList.getNode(0);
        ...
        void shouldAddNodeAtLastOfLinkedList() {
            ...
            assertEquals(3, linkedList.getSize());
            Optional<String> rlt = linkedList.getNode(0);
            assertEquals("First Node", rlt.isPresent() ? rlt.get() : Optional.empty());
            Iterator<String> iterator = linkedList.iterator();
            if (iterator.hasNext()) {
                Optional<String> rlt2 = linkedList.getNode(0);
                assertEquals("Second Node", rlt2.isPresent() ?  iterator.next() : Optional.empty());
        ...
        void shouldGetMiddleNodeWhenListHasOddNodes() {
            ...
            linkedList.addLast("Third Node");
            assertEquals(3, linkedList.getSize());
            Optional<String> rlt = linkedList.getMiddle();
            assertEquals("Second Node", rlt.isPresent() ? rlt.get() : Optional.empty());
        }
        ...
        void shouldGetMiddleNodeWhenListHasEvenNodes() {
            ...
            assertEquals(4, linkedList.getSize());
            Optional<String> rlt3 = linkedList.getMiddle();
            assertEquals("Third Node", rlt3.isPresent() ? rlt3.get() : Optional.empty());
        }
        ...
        void shouldEmptyListByRemoveLastNode() {
            linkedList.addLast("First Node");
            assertEquals(1, linkedList.getSize());
            Optional<String> rlt = linkedList.removeLast();
            assertEquals(Optional.empty(), rlt.isPresent() ? rlt.get() : Optional.empty());
        ...
        void shouldEmptyListByRemoveFirstNode() {
            linkedList.addStart("First Node");
            assertEquals(1, linkedList.getSize());
            Optional<String> rlt = linkedList.removeStart();
            assertEquals(Optional.empty(), rlt.isPresent() ? rlt.get() : Optional.empty());
            assertEquals(0, linkedList.getSize());
        }
        ...
        void shouldRemoveOnlyNodeAtIndexofList() {
            linkedList.add("First Node", 0);
            assertEquals(1, linkedList.getSize());
            Optional<String> removedNode = linkedList.remove(0);
            assertEquals("First Node", removedNode.get());
            assertEquals(0, linkedList.getSize());
        }
        ...
        void shouldRemoveNodeAtIndexofList() {
            ...
            linkedList.add("Third Node", 2);
            assertEquals(3, linkedList.getSize());
            Optional<String> removedNode = linkedList.remove(1);
            assertEquals("Second Node", removedNode.get());
            assertEquals(2, linkedList.getSize());
            Optional<String> rlt = linkedList.getNode(0);
            assertEquals("First Node", rlt.isPresent() ? rlt.get() : Optional.empty());
            Iterator<String> iterator = linkedList.iterator();
